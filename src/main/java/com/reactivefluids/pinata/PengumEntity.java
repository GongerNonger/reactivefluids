 ...
 */
public class PengumEntity extends BasePinataEntity {
    public PengumEntity(EntityType<? extends Animal> type, Level level) { super(type, level); baseCandyCount = 4; }

    public static AttributeSupplier.Builder createAttributes() {
        return createBasePinataAttributes().add(Attributes.MAX_HEALTH, 12)
                .add(Attributes.MOVEMENT_SPEED, 0.22).add(Attributes.ATTACK_DAMAGE, 1.0)
                .add(Attributes.ARMOR, 1.0);
    }

    @Override public String getPinataSpeciesName() { return "Pengum"; }
    ...
    @Override public List<ItemStack> getCandyDrops() { return List.of(new ItemStack(ModPinataItems.PENGUM_CANDY.get(), 1 + random.nextInt(baseCandyCount))); }
